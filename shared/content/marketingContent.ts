...
export const FEATURES_SECTION_TITLE = 'What you get'
export const FAQ_SECTION_TITLE = 'Common questions'
export const APP_DOWNLOAD_SECTION_TITLE = 'Get the VisaMesa app'
export const APP_DOWNLOAD_LEAD =
  'Download the app, then sign in with the same Google account you use on this website.'
export const CLOSING_CTA_TITLE = 'Ready to get started?'
export const CLOSING_CTA_LEAD =
